...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/_id_-3f15be5c.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-ec08f161.mjs').then((m) => m.default || m)
  }
];
...
const layouts = {
  default: () => import('./_nuxt/default-eb9624e1.mjs').then((m) => m.default || m)
};
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-component-5e953ad8.mjs').then((r) => r.default || r));
...
export { _export_sfc as _, useRuntimeConfig as a, useRoute as b, createError as c, useHead as d, entry$1 as default, useRouter as e, navigateTo as n, useNuxtApp as u };
