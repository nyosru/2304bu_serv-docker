...
//     console.log('77 use/cats document.location.host', document.location.host);
//     if (document.location.host == "localhost:3000") {
//       return $fetch(`https://api.bu72.local/api/posts`);
//     } else {
//       return $fetch(`https://api.${document.location.host}/api/posts`);
//     }
//   });
// };
